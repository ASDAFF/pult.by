...
//noindex,nofollow
if ($arResult["ELEMENT"]["PROPERTIES"]["ROBOTS"]["VALUE"] == "Y"){
	$robots = array();
	if ($arResult["ELEMENT"]["PROPERTIES"]["INDEX"]["VALUE"]){
		$robots[] = $arResult["ELEMENT"]["PROPERTIES"]["INDEX"]["VALUE"];
	}
	if ($arResult["ELEMENT"]["PROPERTIES"]["FOLLOW"]["VALUE"]){
		$robots[] = $arResult["ELEMENT"]["PROPERTIES"]["FOLLOW"]["VALUE"];
	}
	$strRobots = implode(",",$robots);
	if ($strRobots){
		$APPLICATION->SetPageProperty("robots",$strRobots);
	}
}
