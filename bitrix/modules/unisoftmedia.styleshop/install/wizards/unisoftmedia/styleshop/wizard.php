...
class SelectTemplateStep extends CSelectTemplateWizardStep
{
	...
	function OnPostForm()
	{
		...
		if ($wizard->IsNextButtonClick())
		{
			...
			if (in_array($templateID,  array("styleshop")))
				$wizard->SetVar("templateID", "styleshop");
			else
				$wizard->SetVar("templateID", "styleshop");
		}
	}
	...
	function ShowStep()
	{
		...
		if (in_array("styleshop", array_keys($arTemplates)))
		{
			$arTemplateOrder[] = "styleshop";
		}

		$defaultTemplateID = COption::GetOptionString("main", "wizard_template_id", "styleshop", $wizard->GetVar("siteID"));
		if (!in_array($defaultTemplateID, array("styleshop"))) $defaultTemplateID = "styleshop";
		...
		$arTemplateInfo = array(
			"styleshop" => array(
				...
				"DESCRIPTION" => "",
				"PREVIEW" => $wizard->GetPath()."/site/templates/styleshop/images/".LANGUAGE_ID."/preview.gif",
				"SCREENSHOT" => $wizard->GetPath()."/site/templates/styleshop/images/".LANGUAGE_ID."/screen.gif",
			),
		);
...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	function InitStep()
	{
		...
		if ($wizard->GetVar("templateID") == "styleshop")
		{
