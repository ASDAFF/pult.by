...
$APPLICATION->SetTitle($arParams['PAGER_TITLE'].' "'.$arResult["REQUEST"]["QUERY"].'"');
?>
<div class="search-page">
<form action="" method="get">
<div class="form-group">
	<div class="input-group col-xs-12 col-sm-9 col-md-7">
		...
		<?endif;?>
			<div class="input-group-btn">
				<button type="submit" class="btn btn-default" ><?=GetMessage("SEARCH_GO")?></button>
