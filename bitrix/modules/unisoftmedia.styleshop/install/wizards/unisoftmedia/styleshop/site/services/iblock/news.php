...
if(COption::GetOptionString("eshop", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCodeNews = "news_".WIZARD_SITE_ID;
		$iblockTypeNews = "news";
    $iblockCodeNews1 = "action_".WIZARD_SITE_ID;
		$iblockTypeNews1 = "news";
		
		$rsIBlock = CIBlock::GetList(array(), array("XML_ID" => $iblockCodeNews, "TYPE" => $iblockTypeNews));
		$iblockID = false;
        ...
        $rsIBlock1 = CIBlock::GetList(array(), array("XML_ID" => $iblockCodeNews1, "TYPE" => $iblockTypeNews1));
		$iblockID1 = false;
		if ($arIBlock1 = $rsIBlock1->Fetch())
		{
			CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("ACTION_IBLOCK_ID" => $iblockID1));
		}
	}
	return;
}
...
$iblockXMLFile1 = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/action.xml"; 
$iblockCodeNews1 = "action_".WIZARD_SITE_ID;
$iblockTypeNews1 = "news";
...
if ($arIBlock1 = $rsIBlock1->Fetch())
{
	$iblockID1 = $arIBlock1["ID"]; 
	if (WIZARD_INSTALL_DEMO_DATA)
	{
		CIBlock::Delete($arIBlock1["ID"]); 
		$iblockID1 = false; 
	}
}
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/action/index.php", array("ACTION_IBLOCK_ID" => $iblockID1));
WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."/include/", Array("NEWS_IBLOCK_ID" => $iblockID));
WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."/include/", Array("ACTION_IBLOCK_ID" => $iblockID1));
WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."/templates/", Array("NEWS_IBLOCK_ID" => $iblockID));
WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."/templates/", Array("ACTION_IBLOCK_ID" => $iblockID1));
?>