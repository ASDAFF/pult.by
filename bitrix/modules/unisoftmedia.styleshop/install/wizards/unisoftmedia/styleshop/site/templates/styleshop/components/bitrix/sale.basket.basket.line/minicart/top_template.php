...
?>
		<a class="dropdown-toggle"<?if($arParams["SHOW_PRODUCTS"] == 'Y'): ?> data-toggle="dropdown" role="button"<?endif?> href="javascript:void(0)"><span class="minicart-text"><?=Loc::getMessage('TSB1_CART2')?></span></a>
