...
___writeToAreasFile(WIZARD_SITE_PATH."include/slogon.php", $wizard->GetVar("siteName"));
...
___writeToAreasFile(WIZARD_SITE_PATH."include/contact.php", $wizard->GetVar("siteTelephone"));
...
WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."include/", Array("TEMPLATE_ID" => WIZARD_TEMPLATE_ID));
WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."templates/", Array("TEMPLATE_ID" => WIZARD_TEMPLATE_ID));
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.".footer_dop.menu.php", Array("SITE_DIR" => WIZARD_SITE_DIR));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.".footer_information.menu.php", Array("SITE_DIR" => WIZARD_SITE_DIR));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.".footer_menu.menu.php", Array("SITE_DIR" => WIZARD_SITE_DIR));
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/contact.php", Array("PHONE" => $wizard->GetVar("siteTelephone")));

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/sect_sidebar.php", Array("TEMPLATE_ID" => WIZARD_TEMPLATE_ID));
...
$arNewUrlRewrite = array(
	...
	array(
		"CONDITION"	=>	"#^".WIZARD_SITE_DIR."about/store/#",
		"RULE"	=>	"",
		"ID"	=>	"bitrix:catalog.store",
		"PATH"	=>	WIZARD_SITE_DIR."about/store/index.php",
	)
);
