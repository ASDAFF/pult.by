...
if ($IBLOCK_CATALOG_ID)
{
	...
	$arUserFields = array("UF_IMAGE_MENU", "UF_INDENT", "UF_INDENT_BOTTOM", "UF_BROWSER_TITLE", "UF_KEYWORDS", "UF_META_DESCRIPTION");
...
//delete 1c props
    ...
    WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."personal/", Array("OFFERS_IBLOCK_ID" => $IBLOCK_OFFERS_ID));
    WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."include/", Array("CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
    WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."include/", Array("OFFERS_IBLOCK_ID" => $IBLOCK_OFFERS_ID));
    WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."templates/", Array("CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
    WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."templates/", Array("OFFERS_IBLOCK_ID" => $IBLOCK_OFFERS_ID));
    CWizardUtil::ReplaceMacrosRecursive(WIZARD_SITE_PATH."/brands/", array("CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
    CWizardUtil::ReplaceMacrosRecursive(WIZARD_SITE_PATH."/brands/", array("OFFERS_IBLOCK_ID" => $IBLOCK_OFFERS_ID));

    CWizardUtil::ReplaceMacrosRecursive(WIZARD_SITE_PATH."/catalog/", array("CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
    CWizardUtil::ReplaceMacrosRecursive(WIZARD_SITE_PATH."/catalog/", array("OFFERS_IBLOCK_ID" => $IBLOCK_OFFERS_ID));
