...
$dbHblock = HL\HighloadBlockTable::getList(
array(
	"filter" => array("NAME" => "SizesClothes")
)
);
if($arData = $dbHblock->Fetch())
{
	...
	$data = array(
		'NAME' => 'SizesClothes',
		'TABLE_NAME' => 'b_hlbd_sizesclothes',
	);

	$result = HL\HighloadBlockTable::add($data);
	$ID = $result->getId();

	$_SESSION["ESHOP_HBLOCK_SIZECLOTHES_ID"] = $ID;
	...
	$arUserFields = array (
		...
		array (
			...
			'FIELD_NAME' => 'UF_FULL_DESCRIPTION',
			'USER_TYPE_ID' => 'string',
			'XML_ID' => 'UF_SIZECLOTHES_FULL_DESCR',
			'SORT' => '500',
			'MULTIPLE' => 'N',
			'MANDATORY' => 'N',
			'SHOW_FILTER' => 'N',
		...
		array (
			...
			'FIELD_NAME' => 'UF_EXTERNAL_CODE',
			'USER_TYPE_ID' => 'string',
			'XML_ID' => 'UF_SIZECLOTHES_EXTERNAL_CODE',
			'SORT' => '700',
			'MULTIPLE' => 'N',
			'MANDATORY' => 'N',
			'SHOW_FILTER' => 'N',
...
if($arData = $dbHblock->Fetch())
{
	...
	$data = array(
		'NAME' => 'SizesShoes',
		'TABLE_NAME' => 'b_hlbd_sizesshoes',
	);

	$result = HL\HighloadBlockTable::add($data);
	$ID = $result->getId();

	$_SESSION["ESHOP_HBLOCK_SIZESHOES_ID"] = $ID;
	...
	$arUserFields = array (
		...
		array (
			...
			'FIELD_NAME' => 'UF_FULL_DESCRIPTION',
			'USER_TYPE_ID' => 'string',
			'XML_ID' => 'UF_SIZESHOES_FULL_DESCR',
			'SORT' => '500',
			'MULTIPLE' => 'N',
			'MANDATORY' => 'N',
			'SHOW_FILTER' => 'N',
		...
		array (
			...
			'FIELD_NAME' => 'UF_EXTERNAL_CODE',
			'USER_TYPE_ID' => 'string',
			'XML_ID' => 'UF_SIZESHOES_EXTERNAL_CODE',
			'SORT' => '700',
			'MULTIPLE' => 'N',
			'MANDATORY' => 'N',
			'SHOW_FILTER' => 'N',
...
if($arData = $dbHblock->Fetch())
{
	...
	$data = array(
		'NAME' => 'TableSize',
		'TABLE_NAME' => 'b_hlbd_tablesize',
	);

	$result = HL\HighloadBlockTable::add($data);
	$ID = $result->getId();

	$_SESSION["ESHOP_HBLOCK_TABLESIZE_ID"] = $ID;
	...
	$arUserFields = array (
		...
		array (
			...
			'FIELD_NAME' => 'UF_FULL_DESCRIPTION',
			'USER_TYPE_ID' => 'string',
			'XML_ID' => 'UF_TABLESIZE_FULL_DESCR',
			'SORT' => '500',
			'MULTIPLE' => 'N',
			'MANDATORY' => 'N',
			'SHOW_FILTER' => 'N',
		...
		array (
			...
			'FIELD_NAME' => 'UF_EXTERNAL_CODE',
			'USER_TYPE_ID' => 'string',
			'XML_ID' => 'UF_TABLESIZE_EXTERNAL_CODE',
			'SORT' => '700',
			'MULTIPLE' => 'N',
			'MANDATORY' => 'N',
			'SHOW_FILTER' => 'N',
