...
?>
    <div class="catalog-sidebar block <?php echo $arParams['CLASS_CONTAINER'] ?>">
		<?
		...
		?><ul class="unproduct list-unstyled <?if($arParams['USE_CAROUSEL'] == 'Y'):?>owl-carousel Owlcarousel<?endif?>" <?if($arParams['USE_CAROUSEL'] == 'Y'):?>data-options="<?php echo CUtil::PhpToJSObject($sliderOptions, false, true); ?>"<?endif?>><?
...
?>
												...
												class="btn btn-sm offers add2basket add2basket_<?php echo $arItem['OFFERS'][$arItem['OFFERS_SELECTED']]['ID'] ?> un_buttoncart"
												data-options="<?php echo CUtil::PhpToJSObject($arSettingsBasket, false, true); ?>"
										...
										} else if($arParams['HIDE_ADDBASKET'] != 'Y') {
											?><a class="btn btn-sm un_buttoncart more" role="button" title="<?php echo $arParams['MESS_BTN_DETAIL']?>" href="<?php echo $arItem["DETAIL_PAGE_URL"]?>">
