...
if($arResult['HAS_MAIN_PRODUCTS'])
{
	...
	$APPLICATION->IncludeComponent(
		...
		array(
			...
			"MESS_TITLE" => (empty($arParams['HIDE_BLOCK_TITLE']) || $arParams['HIDE_BLOCK_TITLE'] !== 'Y') ? $arParams['BLOCK_TITLE'] : '',
