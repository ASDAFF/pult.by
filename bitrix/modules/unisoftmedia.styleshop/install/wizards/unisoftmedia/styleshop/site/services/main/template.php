...
if (!in_array($wizrdTemplateId, array("eshop_adapt_horizontal", "eshop_adapt_vertical", "eshop_vertical", "eshop_horizontal", "eshop_vertical_popup"))) $wizrdTemplateId = "eshop_horizontal";
	\Bitrix\Main\Config\Option::set("main", "wizard_template_id", $wizrdTemplateId, '', WIZARD_SITE_ID);
?>
