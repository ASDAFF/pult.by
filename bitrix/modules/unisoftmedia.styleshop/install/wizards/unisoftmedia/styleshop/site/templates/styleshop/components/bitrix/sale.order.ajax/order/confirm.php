...
<? if (!empty($arResult["ORDER"])): ?>
	...
	<table class="sale_order_full_table">
		<tr>
			<td>
			<div class="sale_order_access"></div>
						...
						<table class="sale_order_full_table">
							<tr>
								<td class="ps_logo">
									...
									<?= CFile::ShowImage($arPaySystem["LOGOTIP"], 100, 100, "border=0\" class=\"img-thumbnail\" style=\"width:100px\"", "", false) ?>
							...
							<tr>
								<td>
									<? if (strlen($arPaySystem["ACTION_FILE"]) > 0 && $arPaySystem["NEW_WINDOW"] == "Y" && $arPaySystem["IS_CASH"] != "Y"): ?>
										...
										<? endif ?>
									<? else: ?>
										<?=str_replace('type="submit"', 'class="btn btn-primary" type="submit"', $arPaySystem["BUFFERED_OUTPUT"])?>
									<? endif ?>
								</td>
							</tr>
						</table>
