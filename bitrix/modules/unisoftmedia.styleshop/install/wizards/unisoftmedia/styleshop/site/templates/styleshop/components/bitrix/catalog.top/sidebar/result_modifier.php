...
if (!empty($arResult['ITEMS']))
{
	...
	foreach ($arResult['ITEMS'] as $key => $arItem)
	{
		...
		if (empty($productPictures['PICT']))
			...
			if(isset($productPictures['PICT']['ID'])) {
				$arPic = CFile::ResizeImageGet($productPictures['PICT']['ID'],
					array(
				...
				$arPic = array(
					'src' => $productPictures['PICT']['SRC'],
					'width' => $productPictures['PICT']['WIDTH'],
					'height' => $productPictures['PICT']['HEIGHT']
				);
			}
			
			$arItem['PREVIEW_PICTURE'] = array(
				'ID' => $productPictures['PICT']['ID'],
				'SRC' => $arPic['src'],
				'WIDTH' => $arPic['width'],
				'HEIGHT' => $arPic['height'],
			);
			$arItem['PRODUCT_PREVIEW'] = array(
				'ID' => $productPictures['PICT']['ID'],
				'SRC' => $arPic['src'],
				'WIDTH' => $arPic['width'],
				'HEIGHT' => $arPic['height'],
		...
		if (!empty($productPictures['SECOND_PICT'])) {
			$arPic = CFile::ResizeImageGet($productPictures['SECOND_PICT']['ID'],
				array(
					"width" => $arParams['MAX_WIDTH'],
					"height" => $arParams['MAX_HEIGHT']
				),
		...
		$arItem['PREVIEW_PICTURE_SECOND'] = array(
			'ID' => $productPictures['SECOND_PICT']['ID'],
			'SRC' => $arPic['src'],
			'WIDTH' => $arPic['width'],
			'HEIGHT' => $arPic['height'],
		);
		...
		$arItem['PRODUCT_PREVIEW_SECOND'] = array(
			'ID' => $productPictures['SECOND_PICT']['ID'],
			'SRC' => $arPic['src'],
			'WIDTH' => $arPic['width'],
			'HEIGHT' => $arPic['height'],
		...
		if ($arItem['CATALOG'] && isset($arItem['OFFERS']) && !empty($arItem['OFFERS']))
		{
			if ('Y' == $arParams['PRODUCT_DISPLAY_MODE'])
			{
				...
				foreach ($arItem['OFFERS'] as $keyOffer => $arOffer)
				{
					...
					{
						$arPic = CFile::ResizeImageGet($offerPictures['PICT']['ID'],
							array(
								"width" => $arParams['MAX_WIDTH'],
								"height" => $arParams['MAX_HEIGHT']
							),
						...
						if (!empty($offerPictures['SECOND_PICT'])) {
							$arPic = CFile::ResizeImageGet($offerPictures['SECOND_PICT']['ID'],
								array(
									"width" => $arParams['MAX_WIDTH'],
									"height" => $arParams['MAX_HEIGHT']
								),
						...
						$arOffer['PREVIEW_PICTURE_SECOND'] = array(
							'ID' => $offerPictures['SECOND_PICT']['ID'],
							'SRC' => $arPic['src'],
							'WIDTH' => $arPic['width'],
							'HEIGHT' => $arPic['height'],
						);
