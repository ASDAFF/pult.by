...
class unisoftmedia_styleshop extends CModule
{
	var $MODULE_ID = "unisoftmedia.styleshop";
	var $MODULE_VERSION;
	...
	public function InstallFiles()
	{
		...
		CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/".$this->MODULE_ID."/install/modules", $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules", true, true);
	...
	public function UnInstallFiles()
	{
		...
		DeleteDirFilesEx('/bitrix/admin/un_grid_ajax.php');
		DeleteDirFilesEx('/bitrix/admin/un_file_edit.php');
		DeleteDirFilesEx('/bitrix/themes/'.$this->MODULE_ID.'.css');
		return true;
	}
