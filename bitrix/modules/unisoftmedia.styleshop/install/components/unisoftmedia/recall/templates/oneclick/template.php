...
<?else:?>
<p></p>
<a class="btn btn-default ajax-recall" data-ajax-container="#<?php echo $recallId ?>" data-form-popup="<?=$bxajaxid?>" data-form-title="<?php echo htmlspecialcharsbx($arParams['MESS_TITLE']) ?>" data-form-action="<?=POST_FORM_ACTION_URI?>" href="#"><?php echo htmlspecialcharsbx($arParams['MESS_TITLE']) ?></a>
<?endif?>