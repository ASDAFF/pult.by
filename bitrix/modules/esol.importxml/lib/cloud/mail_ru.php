...
class MailRu
{
	...
	public static function GetInstance()
	{
		...
		{
			$user = \Bitrix\Main\Config\Option::get('esol.importxml', 'CLOUD_MAILRU_LOGIN', '');
			$pass = \Bitrix\Main\Config\Option::get('esol.importxml', 'CLOUD_MAILRU_PASSWORD', '');
	...
	public function download($tmpPath, $path)
	{
