	...
	else
	{
				...
				<div class="blog-comment-fields">
					...
					if(empty($arResult["User"]))
					{
						...
						<div class="blog-comment-field blog-comment-field-user">
							<div class="blog-comment-field blog-comment-field-author"><div class="blog-comment-field-text"><label for="user_name"><?=GetMessage("B_B_MS_NAME")?></label><span class="blog-required-field">*</span></div><span><input maxlength="255" size="30" tabindex="3" type="text" class="form-control" name="user_name" id="user_name" value="<?=htmlspecialcharsEx($_SESSION["blog_user_name"])?>"></span></div>
							<div class="blog-comment-field-user-sep">&nbsp;</div>
							<div class="blog-comment-field blog-comment-field-email"><div class="blog-comment-field-text"><label for="">E-mail</label></div><span><input maxlength="255" size="30" tabindex="4" type="text" class="form-control" name="user_email" id="user_email" value="<?=htmlspecialcharsEx($_SESSION["blog_user_email"])?>"></span></div>
					...
					if($arResult["use_captcha"]===true)
					{
						...
						<div class="blog-comment-field blog-comment-field-captcha">
							<div class="blog-comment-field-captcha-label">
								...
								<input type="text" class="form-control" size="30" name="captcha_word" id="captcha_word" value=""  tabindex="7">
								</div>
					...
					<div class="blog-comment-buttons">
						<button type="button" class="btn btn-primary" name="sub-post" id="post-button" onclick="submitComment()"><?=GetMessage("B_B_MS_SEND")?></button>
					</div>
				</div>
		...
		if($arResult["is_ajax_post"] != "Y")
		{
			if($arResult["CanUserComment"])
			{
				...
				?>
				<div class="blog-add-comment"><a class="btn btn-primary" href="javascript:void(0)" onclick="return showComment('0')"><?=GetMessage("B_B_MS_ADD_COMMENT")?></a><br /></div>
				<a name="0"></a>
				<?
