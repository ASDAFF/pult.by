...
if (!empty($arResult))
{ ?>
    <ul class="nav nav-pills pull-right responsive-menu" id="top-menu"><?
        ...
        <li class="menu-item-link dropdown more" data-hover="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"><?php echo Loc::getMessage('MORE') ?></a>
