...
<div class="notice">
	...
	<?elseif ($arResult["STATUS"] == "N"):?>
		<span id="url_notify_<?=$arParams['NOTIFY_ID']?>"><a class="notice-link" href="javascript:void(0)" onClick="notifyProduct('<?=$arResult["NOTIFY_URL"]?>', <?=$arParams['NOTIFY_ID']?>);"><?=GetMessage('NOTIFY');?></a></span>
	<?elseif ($arResult["STATUS"] == "R"):?>
		<span id="url_notify_<?=$arParams['NOTIFY_ID']?>">
			<a class="notice-link" href="javascript:void(0)" onClick="showNotify(<?=$arParams['NOTIFY_ID']?>)" id="notify_product_<?=$arParams['NOTIFY_ID']?>"><?=GetMessage('NOTIFY');?></a>
		</span>
	<?endif;?>
...
?>
	...
	<div class="notice" id="popup_form_notify" style="display: none;">
		<input type="hidden" value="" name="popup_notify_url" id="popup_notify_url">
		<div class="panel">
			<div class="panel-heading"><?=GetMessage('NOTIFY_TITLE');?></div>
			<div class="panel-body">
				<p id="popup_n_error" class="text-danger"></p>
				<table border="0" cellpadding="4" cellspacing="0" width="300">
					<tr>
						...
						<td class="padding-left" valign="top">
							<input type="text" value="" class="form-control" name="popup_user_email" id="popup_user_email" size="25">

							<table width="100%" style="display: none;" id="popup-buyer-auth-form">
								<tr>
									<td>
										<div class="form-group">
											<label for="notify_user_login"><?=GetMessage('NOTIFY_POPUP_LOGIN');?>:</label>
											<input type="text" class="form-control" name="notify_user_login" id="notify_user_login" maxlength="50" value="" size="25" />
										</div>
									</td>
								</tr>
								<tr>
									<td>
										<div class="form-group">
											<label for="notify_user_password"><?=GetMessage('NOTIFY_POPUP_PASSW');?>:</label>
											<input type="password" class="form-control" name="notify_user_password" id="notify_user_password" maxlength="50" size="25" />
										</div>
									</td>
								</tr>
							</table>
					...
					<?if($arResult["CAPTCHA_CODE"]):?>
						...
						<tr>
							...
							<td><input class="form-control" type="text" name="popup_captcha_word" id="popup_captcha_word" maxlength="50" value="" size="15" /></td>
						</tr>
					<?endif;?>
					</tr>
				</table>
