...
<!--	MAIN BLOCK	-->
	<div class="col-md-9 bx-soa">
		...
		<div id="bx-soa-total-mobile" style="margin-bottom: 6px;" class="visible-sm"></div>
		...
		<div id="bx-soa-orderSave">
			...
			<a href="javascript:void(0)" style="margin: 10px 0" class="pull-right btn btn-primary btn-lg" data-save-button="true">
				<?=$arParams['MESS_ORDER']?>
			</a>
		</div>
