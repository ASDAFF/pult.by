...
?>
<div class="bx-subscribe-sidebar block well well-sm clearfix"  id="sidebar-sender-subscribe">
<?
$frame = $this->createFrame("sidebar-sender-subscribe", false)->begin();
?>
	<script>
		BX.ready(function()
		{
...
<div class="col-xs-12">
	<div class="h3 subscribe-title"><?php echo htmlspecialcharsbx($arParams['MESS_TITLE']) ?></div>
	<p><?php echo htmlspecialcharsbx($arParams['MESS_DESC']) ?></p>
			...
			<div class="input-group col-xs-12">
				...
				<div class="input-group-btn">
					<button class="btn btn-default" id="bx_subscribe_btn_<?=$buttonId?>">
						<span><?=Loc::getmessage("subscr_form_button")?></span>
					</button>
				</div>
			</div>
			<?if(isset($arResult['MESSAGE'])):?>
					<div id="sidebar-sender-subscribe-response-cont">
...
?>
	<?if(isset($arResult['MESSAGE'])): CJSCore::Init(array("popup"));?>
		<div id="sidebar-sender-subscribe-response-cont" style="display: none;">
