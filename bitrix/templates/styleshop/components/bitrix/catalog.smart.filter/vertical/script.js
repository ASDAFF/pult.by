...
$(function(){
	...
	$(document).on('click.bs.dropdown.data-api', '.bx-filter .btn-group .dropdown-menu a', function(e) {
		e.preventDefault();
	...
	$(document).on('click', '.filter-name', function() {
		$(this).parent().children('.bx-filter-section').stop(true, true).slideToggle();
	});
