...
<div class="bx-filter block" id="SFilter">
	<div class="filter-name btn btn-lg btn-default btn-block hidden-sm hidden-lg hidden-md"><?=GetMessage('FILTER_NAME')?></div>
			...
			<div class="row">
				<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
					...
					if(isset($arItem["PRICE"])):
						...
						<div class="panel panel-default bx-filter-parameters-box bx-active">
							...
							<div class="panel-heading" onclick="smartFilter.hideFilterProps(this)"><?=$arItem["NAME"]?></div>
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					if (
						...
						continue;
					?>
					<div class="panel panel-default bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
						<span class="bx-filter-container-modef"></span>
						<div class="panel-heading" onclick="smartFilter.hideFilterProps(this)"><?=$arItem["NAME"]?></div>
						<div class="panel-body" data-role="bx_filter_block">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
									...
									<?foreach ($arItem["VALUES"] as $val => $ar):?>
										<div class="checkbox">
											...
											if ($ar["DISABLED"])
												$class.= " disabled";
											?>
											<label for="<?=$ar["CONTROL_ID"]?>" data-role="label_<?=$ar["CONTROL_ID"]?>" class="bx-filter-p-0 bx-filter-param-label<?=$class?>" onclick="smartFilter.keyup(BX('<?=CUtil::JSEscape($ar["CONTROL_ID"])?>')); BX.toggleClass(this, 'bx-active');">
												<span class="bx-filter-param-btn bx-color-sl">
													<?if (isset($ar["FILE"]) && !empty($ar["FILE"]["SRC"])):?>
														<span class="bx-filter-btn-color-icon" style="background-image:url('<?=$ar["FILE"]["SRC"]?>');"></span>
													<?endif?>
								...
								case "P"://DROPDOWN
									...
									<?foreach ($arItem["VALUES"] as $val => $ar):?>
										...
										?>
										<li class="<? echo $currentselected ?><? echo $currentdisabled ?>">
											<input
												class="hide"
												type="radio"
											...
											/>
											<a data-role="label_<?=$ar["CONTROL_ID"]?>" onclick="smartFilter.selectDropDownItem(this, '<?=CUtil::JSEscape($ar["CONTROL_ID"])?>')" href="#" data-value="<? echo $ar["HTML_VALUE_ALT"] ?>">
									...
									<div class="btn-group">
										<button type="button" class="btn dropdown-toggle btn-default" data-toggle="dropdown">
											<span class="filter-option"><span class="text"><?=($selected)?$selected:GetMessage("CT_BCSF_FILTER_ALL")?></span></span>&nbsp;<span class="caret"></span>
										</button>
										<ul class="dropdown-menu">
										<li class="<? echo !$selected? ' selected': '' ?>">
											<input
												class="hide"
												type="radio"
												...
												value=""
											/>
											<a href="#" data-value="" onclick="smartFilter.selectDropDownItem(this, '<?=CUtil::JSEscape("all_".$arCur["CONTROL_ID"])?>')"><span class="text"><?php echo GetMessage("CT_BCSF_FILTER_ALL"); ?></span></a>
										</li>
								...
								case "R"://DROPDOWN_WITH_PICTURES_AND_LABELS
									...
									<div class="btn-group">
										<button type="button" class="btn dropdown-toggle btn-default" data-toggle="dropdown">
											...
											<?if($file):?>
												<span class="bx-filter-btn-color-icon" style="background-image:url('<?=$file?>');"></span>
												<?else:?>
												<span class="bx-filter-btn-color-icon all"></span>
											<?endif?>
											<span class="text"><?=($selected)?$selected:GetMessage("CT_BCSF_FILTER_ALL")?></span></span>&nbsp;<span class="caret"></span>
										</button>
										<ul class="dropdown-menu">
										<li class="<? echo !$selected? ' selected': '' ?>">
											<input
												...
												value=""
											/>
											<a href="#" data-value="" onclick="smartFilter.selectDropDownItem(this, '<?=CUtil::JSEscape("all_".$arCur["CONTROL_ID"])?>')">
												<span class="bx-filter-btn-color-icon all"></span>
												<span class="text"><?php echo GetMessage("CT_BCSF_FILTER_ALL"); ?></span>
											</a>
										</li>
										<li role="separator" class="divider"></li>
											<?echo $option?>
								...
								default://CHECKBOXES
									?>
									<?foreach($arItem["VALUES"] as $val => $ar):?>
										<div class="checkbox<? echo $ar["DISABLED"] ? ' disabled': '' ?>">
											<input
												type="checkbox"
												class="checkbox-icon"
