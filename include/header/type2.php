			...
			<div class="container">
				<div class="row">
					<div class="top-panel-left col-md-6 col-lg-6">
						<?$APPLICATION->IncludeComponent("unisoftmedia:wishlist.list", ".default", array(
							...
							<div class="row">
								<div class="block-table">
			                        ...
			                        Array('HIDE_ICONS' => 'N')
											...
											<div class="col-xs-12 col-sm-12 col-md-3 block-table-td hidden-xs hidden-sm">
												<div class="slogon">
													<?$APPLICATION->IncludeComponent(
			                        "bitrix:main.include",
			                        "",
