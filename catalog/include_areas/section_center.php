<?$APPLICATION->IncludeComponent("bitrix:catalog.top", "catalog", array(
...
<?$APPLICATION->IncludeComponent("bitrix:catalog.bigdata.products", "catalog", array(
	"ACTION_VARIABLE" => "action",
		"ADDITIONAL_PICT_PROP_9" => "MORE_PHOTO",
		"ADDITIONAL_PICT_PROP_10" => "MORE_PHOTO",
		"ADD_PROPERTIES_TO_BASKET" => "Y",
...
<?$APPLICATION->IncludeComponent("bitrix:sale.bestsellers", "catalog", array(
	"ACTION_VARIABLE" => "action",
		"ADDITIONAL_PICT_PROP_9" => "MORE_PHOTO",
		"ADDITIONAL_PICT_PROP_10" => "MORE_PHOTO",
		"ADD_PROPERTIES_TO_BASKET" => "Y",
